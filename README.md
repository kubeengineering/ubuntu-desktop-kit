...
**Свободное место есть, а записать нельзя.** При установке всех наборов значков `git` оборвался с «на устройстве не осталось свободного места», хотя `df` показывал двадцать свободных гигабайт. Кончились иноды: набор значков — это сотни тысяч крохотных SVG, и таблица инодов исчерпывается заметно раньше. Теперь перед скачиванием проверяется и то, и другое.
